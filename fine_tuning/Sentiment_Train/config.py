...
MODEL_OUTPUT_ROOT = os.path.join(PROJECT_ROOT, "fine_tuning_output", "sentiment_output", "models")
PLOT_OUTPUT_ROOT  = os.path.join(PROJECT_ROOT, "fine_tuning_output", "sentiment_output", "plots")
